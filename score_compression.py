...
def compute_fisher(mock_run, fiducial_run, deriv_params, data_params, mocks_dir = None, mocks_name = None):
    """
...
def write_file(input_array, file_location):
    ...
    print("File succesfully saved as %s.dat" % str(file_location))

if __name__ == "__main__":
    compressed_data, thetas, fid_data =  do_compression(sim_number = 8001, fiducial_run = 8001, data_run = 8000,
    ...
    write_file(input_array = compressed_data, file_location = '/home/ruyi_wsl/kcap_output/kids_1000_mocks_trial_4/compressed_data/compressed_data')
    write_file(input_array = thetas, file_location = '/home/ruyi_wsl/kcap_output/kids_1000_mocks_trial_4/compressed_data/thetas')
    write_file(input_array = fid_data, file_location = '/home/ruyi_wsl/kcap_output/kids_1000_mocks_trial_4/compressed_data/fid_data')