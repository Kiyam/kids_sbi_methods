...
if __name__ == "__main__":
    ...
    # j = 0
    # for i in range(1600):
    #     if os.path.isfile('/share/lustre/klin/kcap_out/kids_1000_glass_mocks/pcl_cov_2/glass_salmo_sims_'+str(i)+'.tgz'):
    #         while os.path.isfile('/share/lustre/klin/kcap_out/kids_1000_glass_mocks/pcl_cov/glass_salmo_sims_'+str(j)+'.tgz'):
    #             j += 1
    #         # if i != j:
    #         else:
    #             move_tar('/share/lustre/klin/kcap_out/kids_1000_glass_mocks/pcl_cov_2/glass_salmo_sims_'+str(i), '/share/lustre/klin/kcap_out/kids_1000_glass_mocks/pcl_cov/glass_salmo_sims_'+str(j), copy = False)
    #             j += 1
    ...
    #     move_tar('/share/lustre/klin/kcap_out/kids_fiducial_data_mocks/glass_fiducial', '/share/lustre/klin/kcap_out/deriv_tests/5pt_stencil/glass_mocks_stepsize_deriv_'+str(val), copy = True)
